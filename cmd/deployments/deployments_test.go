...
func TestList(t *testing.T) {
	mt := &mockTransport{responses: []mockResponse{
		{200, `{"data":[{"id":"d1","project_id":"p1","cluster_id":"c1","package_id":"pkg1","status":"deployed"}]}`},
	}}
...
func TestCreate(t *testing.T) {
	mt := &mockTransport{responses: []mockResponse{
		{201, `{"data":{"id":"d2","project_id":"p1","cluster_id":"c1","package_id":"pkg1","status":"pending"}}`},
	}}
	ctx, out := buildCtx(t, mt, true)
	parent := deployments.NewCommand()
	...
	sub.SetContext(ctx)
	if err := sub.ParseFlags([]string{"--project-id", "p1", "--cluster-id", "c1", "--package-id", "pkg1"}); err != nil {
		t.Fatal(err)
	}
	if err := sub.RunE(sub, []string{}); err != nil {
...
func TestUpdate(t *testing.T) {
	mt := &mockTransport{responses: []mockResponse{
		{200, `{"data":{"id":"d1","project_id":"p1","cluster_id":"c1","package_id":"pkg2","status":"deployed"}}`},
	}}
	ctx, out := buildCtx(t, mt, true)
	parent := deployments.NewCommand()
