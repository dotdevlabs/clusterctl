...
var opCommandMap = map[string][]string{
	...
	"getDeploymentPackageUpdate":    {"deployments", "package-update", "get"},
	"createDeploymentPackageUpdate": {"deployments", "package-update", "apply"},
	"createDeploymentRollout":       {"deployments", "rollout"},
